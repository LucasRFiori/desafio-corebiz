export default function Search(){
    ...
    <div className="search">
        <div className="search__container">
            <input type="text" placeholder="O que está procurando?" maxLength="200" />
            <button className="button--search"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
